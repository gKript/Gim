 ...
 * MD5 context setup
 */
void gim_md5_obj::MD5Init( md5_context *ctx )
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
 ...
 * MD5 process buffer
 */
void gim_md5_obj::MD5Update( md5_context *ctx, unsigned char *input , int ilen ) {
    int fill;
    unsigned long left;
 ...
 * MD5 final digest
 */
void gim_md5_obj::MD5Final( unsigned char output[16] , MD5_CTX *ctx ) {
