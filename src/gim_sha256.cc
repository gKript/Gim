 ...
 * SHA-2 context setup
 */
void gim_sha256_obj::SHA256_init( sha2_context *ctx )
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
 ...
 */
void gim_sha256_obj::SHA256_update( sha2_context *ctx, unsigned char *input, int ilen )
{
    int fill;
    unsigned long left;
 ...
 * SHA-2 final digest
 */
void gim_sha256_obj::SHA256_final( sha2_context *ctx, unsigned char output[32] )
{
